...
#Actual data: http://py4e-data.dr-chuck.net/comments_46074.html (Sum ends with 19)
...
#You can ignore most of the data in the file except for
...
#text content
#of the span tag, convert them to integers and add them up
